...
setup(name='SUMELF',
      ...
      download_url = 'https://github.com/geoffreyweal/SUMELF/archive/v'+str(get_version_number())+'.tar.gz',
      ...
      install_requires=['numpy', 'ase>=3.19.0', 'scipy', 'networkx', 'packaging', 'tqdm'],
      classifiers=[
