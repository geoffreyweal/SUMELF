"""
This script is from the atomic simulation environment (https://wiki.fysik.dtu.dk/ase/)

This script has been obtained from https://gitlab.com/ase/ase/-/blob/master/ase/data/__init__.py
"""
