...
def import_CHG_file(CHG_filepath):
	...
	with open(CHG_filepath, 'r') as CHG_FILE:
		for line in CHG_FILE:
			...
			# 2.1: obtain the data about the atom from the line
			symbol, xx, yy, zz, charge = line.rstrip().split()

			# 2.2: Convert x, y, z and charge variables from string to floats
			...
			# 2.3: Add information about the atom to the corresponding lists. 
